...
Starting ttymidi in verbose mode : 

`ttymidi -s /dev/ttyAMA0 -b 38400 -v`

This version adds MIDI one bytes Beatclock commands (Clock, start, stop, continue) 
Needs a complete refactoring but seems to work.
